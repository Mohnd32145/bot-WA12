...
conn.welcome = '*❍━━━══━━❪👑❫━━══━━━❍*\n*❈↲مـ↜ـنـور يا @user اتـمـنـي انـك تـسـتـمـتـع معانا*\n*❍━━━══━━❪👑❫━━══━━━❍*\n*❈↲اسـ↜ـم المـجـمـوعـه↜❪@subject❫*\n*❍━━━══━━❪👑❫━━══━━━❍*\n          *❪⚠️┊تـنـبـيهـات┊⚠️❫*\n    *❍━━━══━━❪👑❫━━══━━━❍*\n> *↜ممنوع دخول للبوت خاص*\n> *↜استخدم❪.القوانين❫ لتعرف قواعد المجموعه*\n> *↜سب البوت=سب المطور*\n> *↜لي اي شكوه او اقتراح استخدم❪.ابلاغ❫*\n*❍━━━══━━❪👑❫━━══━━━❍*'
//conn.bye = '*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*\n\n*❧ وداعاً لـ @user 👋*\n\n*❧ اتمنى لك التوفيق في كل حياتك 😎*\n*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*'
conn.spromote = '*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*\n\n*❧ ألف مبروك يا @user، بقيت من الطاقم 👑*\n*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*'
conn.sdemote = '*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*\n\n*❧ ههههه، يا @user خلاص بقيت مش أدمن 😂*\n*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*'
conn.sDesc = '*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*\n\n*❧ الوصف اتغير لـ \n@desc*\n*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*'
conn.sSubject = '*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*\n\n*❧ اسم المجموعة اتغير لـ \n@group*\n*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*'
conn.sIcon = '*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*\n\n*❧ أيقونة المجموعة اتغيرت*\n*⌯╾╾╾⟞❲𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇❳⟝╾╾╾⌯*'
conn.sRevoke = 'تم تغير رابط المجموعه'
