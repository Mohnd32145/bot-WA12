...
let fakecontact = { 'key': { 'participants': '0@s.whatsapp.net', 'remoteJid': 'status@broadcast', 'fromMe': false, 'id': '𝐘𝐎𝐑𝐔𝐈𝐂𝐇𝐈 |♕| 𝐁𝐎𝐓' }, 'message': { 'contactMessage': { 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` } }, 'participant': '0@s.whatsapp.net' };
let fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '𝑺𝐴𝐹𝑅O𝑇-𝐵O𝑇', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '𝑌𝑜𝑟𝑢𝑖𝑐ℎ𝑖 𝐵𝑜𝓉 𝑀𝐷', 'jpegThumbnail': false}}};
...
isForwarded: false, 
 ...
 body: '𝐘𝐎𝐑𝐔𝐈𝐂𝐇𝐈 |♕| 𝐁𝐎𝐓', 
 sourceUrl: 'https://chat.whatsapp.com/KI1sBGRQlYxGdwoVXZHH2N',
 thumbnail: vn2,
 thumbnailUrl: vn2, 
 mediaType: 1,
