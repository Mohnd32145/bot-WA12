...
import * as welcomeLeave from './plugins/welcome_leave.js';
import ws from 'ws';
...
const messageText = `『تم حظرك من استخدام البوت بواسطه المطور اتواصل معاه 
للتواصل اكتب المطور』
`.trim();
//m.reply(messageText);
...
*┊⇇نفذ منك الالماس*
*┊⇇استخدم امر❪.شراء❫ للمزيد*
*╯═━━━━━✦🌸✦━━━━━═⧈*`, contextInfo: {externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": wm, body: '', previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })         
continue
}
...
if (!m.fromMem && m.text.match(/(@201063808608|بوت|الاستور|تست|:v)/gi)) {
...
const numerosPermitidos = ["855", "265", "92", "91", "90", "210", "60", "61", "62", "40", "48", "49", "93", "94", "98", "258"] //PUEDES EDITAR LOS USUARIOS QUE SE ELIMINARÁN SI EMPIEZA POR CUALQUIER DE ESOS NÚMEROS	
...
let vn = 'https://files.catbox.moe/fagrdd.mp3'
let or = ['texto', 'audio'];
...
"thumbnail": apii.data, 
"title": [wm, '𝑌𝑜𝑟𝑢𝑖𝑐ℎ𝑖 𝐵𝑜𝓉 𝑀𝐷'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: [md, nna, yt, nnn, nn, tiktok].getRandom()}}}, { quoted: fkontak2 }) 
if (media === 'audio')
this.sendMessage(id, { audio: { url: vn }, contextInfo:{ mentionedJid:[user], "externalAdReply": { "thumbnail": apii.data, "title": `「🌸┊مـرحـبـا┊🌸」`, "body": [wm, ' 𝕐𝕠𝕣𝕦𝕚𝕔𝕙𝕚 𝔹𝕠𝕥 𝕄𝔻'].getRandom(), "previewType": "PHOTO", "thumbnailUrl": null, "showAdAttribution": true,  sourceUrl: [md, nna, yt, nn, tiktok].getRandom()}},  ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 })
...
export async function callUpdate(callUpdate) {
    ...
    if (nk.isGroup == false) {
    if (nk.status == "offer") {
    let callmsg = await this.reply(nk.from, `ʜᴏʟᴀ *@${nk.from.split('@')[0]}*, ʟᴀs ${nk.isVideo ? 'videollamadas' : 'llamadas'} ɴᴏ ᴇsᴛᴀɴ ᴘᴇʀᴍɪᴛɪᴅᴀs, sᴇʀᴀs ʙʟᴏǫᴜᴇᴀᴅᴏ.\n\nsɪ ᴀᴄᴄɪᴅᴇɴᴛᴀʟᴍᴇɴᴛᴇ ʟʟᴀᴍᴀsᴛᴇ ᴘᴏɴɢᴀsᴇ ᴇɴ ᴄᴏɴᴛᴀᴄᴛᴏ ᴄᴏɴ ᴍɪ ᴄʀᴇᴀᴅᴏʀ ᴘᴀʀᴀ ǫᴜᴇ ᴛᴇ ᴅᴇsʙʟᴏǫᴜᴇᴇ!\n\nɢʀᴜᴘᴏ ᴀsɪsᴛᴇɴᴄɪᴀ ғᴀᴄᴇʙᴏᴏᴋ: https://facebook.com/groups/990425789/`, false, { mentions: [nk.from] })
    //let data = global.owner.filter(([id, isCreator]) => id && isCreator)
    //await this.sendContact(nk.from, data.map(([id, name]) => [id, name]), false, { quoted: callmsg })
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇-𝙈𝘿 👑;;;\nFN:𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇-𝙈𝘿\nORG:𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇-𝙈𝘿 👑\nTITLE:\nitem1.TEL;waid=+201222784295\nitem1.X-ABLabel:Alakreb-𝙈𝘿 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇-𝙈𝘿 👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇-𝙈𝘿 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn, usedPrefix) => {
    let msg = {
          rowner: `*❪👑❫⇇هـذا الامـر لـلـمـطـوريـن فـقـط*`,
    owner: `*❪👑❫⇇هـذا الامـر لـلـمـالك فـقـط*`,
    mods: `*❪👑❫⇇هـذا الامـر لـلـمـشـرفـيـن فـقـط*`,
    premium: `*❪👑❫⇇هـذا الامـر لـلـ❪VIP❫ فـقـط*`,
    group: `⧈═━━━━━✦👑✦━━━━━═⧈\n*❪👑❫⇇هـذا الامـر فـي الـمـجـمـو؏ـات فـقـط*\n⧈═━━━━━✦👑✦━━━━━═⧈`,
    private: `⧈═━━━━━✦👑✦━━━━━═⧈ \n*❪👑❫⇇هـذا الامـر فـي الـخـاص فـقـط*\n⧈═━━━━━✦👑✦━━━━━═⧈`,
    admin: `*❪👑❫⇇هـذا الامـر لـلـمـشـرفـيـن فـقـط*`,
    botAdmin: `⧈═━━━━━✦👑✦━━━━━═⧈ \n*❪👑❫⇇يجب ان يكون البوت ادمن لي تشغيل هذا الامر*\n⧈═━━━━━✦👑✦━━━━━═⧈`,
    unreg: `*╮═━━━━━✦👑✦━━━━━═⧈* 
*┊⇇ يجب ان تكون مسجل لي هذا الامر*
*┊⇇استخدم امر❪.تسجيل الاسم.العمر❫*
*┊•⪼مثال⇇❪.تسجيل الاستور.16❫*
*╯═━━━━━✦👑✦━━━━━═⧈*`,
    restrict: `⧈═━━━━━✦👑✦━━━━━═⧈ \n*❪👑❫⇇هـذا الامـر مغلق من المطور*\n⧈═━━━━━✦👑✦━━━━━═⧈`
    }[type]
    if (msg) return conn.sendMessage(m.chat, {text: msg, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363413614869774@newsletter', serverMessageId: '', newsletterName: '𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇' }, externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `𝑀𝐼𝐾𝐸𝑌 𝐵𝛩𝑇`, body: wm, previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, nna2, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })
}
conn.ev.on('group-participants.update', welcomeLeave.participantsUpdate);
